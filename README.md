...
| 2 | SECONDARY | `council_subjects_rank` | 0/2 | 0.9385 | 5.82% | 0.43 pt | 0.42 pt | `wip` |
| 3 | SECONDARY | `council_schools_rank` | 0/1 | 0.8987 | 12.80% | 0.68 pt | 0.12 pt | `wip` |
| 4 | SECONDARY | `council_wards_rank` | 0/1 | 0.9599 | 4.97% | 0.43 pt | 0.24 pt | `wip` |
| 5 | SECONDARY | `council_top_schools` | 0/3 | 0.9539 | 5.35% | 0.52 pt | 0.18 pt | `wip` |
| 6 | SECONDARY | `council_best_students` | 0/5 | 0.9330 | 8.33% | 0.49 pt | 0.24 pt | `wip` |
| 7 | SECONDARY | `council_best_students_subjectwise` | 10/30 | 0.9730 | 2.62% | 0.5 pt | 0.66 pt | `wip` |
| 8 | SECONDARY | `council_schools_rank_subjectwise` | 1/24 | 0.9284 | 8.71% | 0.606 pt | 0.54 pt | `wip` |
| 9 | SECONDARY | `subject_schools_rank` | 0/6 | 0.9276 | 8.96% | 0.57 pt | 0.48 pt | `wip` |
| 10 | SECONDARY | `region_schools_rank_overall` | 0/6 | 0.8820 | 13.84% | 0.66 pt | 0.18 pt | `wip` |
| 11 | SECONDARY | `region_schools_rank_government` | 0/4 | 0.8758 | 14.43% | 0.66 pt | 0.18 pt | `wip` |
| 12 | SECONDARY | `region_schools_rank_private` | 0/2 | 0.8997 | 11.30% | 0.66 pt | 0.18 pt | `wip` |
| 13 | SECONDARY | `region_top_schools` | 0/6 | 0.9813 | 2.10% | 0.51 pt | 0.18 pt | `wip` |
| 14 | SECONDARY | `region_best_students_overall` | 0/9 | 0.9350 | 4.67% | 0.72 pt | 0.18 pt | `wip` |
| 15 | SECONDARY | `region_best_students_subjectwise` | 0/23 | 0.9793 | 2.21% | 0.66 pt | 0.6 pt | `wip` |
| 16 | SECONDARY | `region_council_performance` | 0/5 | 0.9767 | 2.81% | 0.54 pt | 0.24 pt | `wip` |
| 17 | SECONDARY | `region_subjects_performance` | 0/2 | 0.9588 | 4.56% | 0.57 pt | 0.72 pt | `wip` |
| 18 | SECONDARY | `region_mobility` | 0/6 | 0.9299 | 8.44% | 0.45 pt | 0.48 pt | `wip` |
| 19 | PRIMARY | `school_results` | 0/5 | 0.9366 | 7.68% | 0.67 pt | 0.48 pt | `wip` |
| 20 | PRIMARY | `council_kata_rank_alama` | 0/2 | 0.9442 | 6.45% | 0.53 pt | 0.42 pt | `wip` |
| 21 | PRIMARY | `council_kata_rank_grading` | 0/1 | 0.9575 | 5.26% | 0.46 pt | 0.36 pt | `wip` |
| 22 | PRIMARY | `council_school_rank_binafsi` | 0/2 | 0.9459 | 8.27% | 0.636 pt | 0.36 pt | `wip` |
| 23 | PRIMARY | `council_school_rank_serikali` | 0/2 | 0.9368 | 8.39% | 0.52 pt | 0.36 pt | `wip` |
| 24 | PRIMARY | `council_school_rank_in_grade` | 0/3 | 0.9062 | 10.48% | 0.73 pt | 0.24 pt | `wip` |
| 25 | PRIMARY | `council_school_rank_ufaulu_alama` | 0/4 | 0.8837 | 12.82% | 0.666 pt | 0.36 pt | `wip` |
| 26 | PRIMARY | `council_best_students` | 0/4 | 0.9552 | 5.03% | 0.53 pt | 0.24 pt | `wip` |
| 27 | PRIMARY | `council_top_schools_alama` | 0/2 | 0.9410 | 5.92% | 0.552 pt | 0.6 pt | `wip` |
| 28 | PRIMARY | `council_top_schools_grading` | 0/3 | 0.9597 | 5.05% | 0.55 pt | 0.18 pt | `wip` |
| 29 | PRIMARY | `council_top_schools_kimasomo_overall` | 0/3 | 0.9593 | 5.04% | 0.56 pt | 0.42 pt | `wip` |
| 30 | PRIMARY | `council_top_schools_kimasomo_serikali` | 0/3 | 0.9451 | 5.52% | 0.55 pt | 0.42 pt | `wip` |
...
| 33 | PRIMARY | `region_kata_serikali` | 0/4 | 0.9169 | 9.93% | 0.72 pt | 0.3 pt | `wip` |
| 34 | PRIMARY | `region_kata_binafsi` | 0/2 | 0.9288 | 8.90% | 0.63 pt | 0.3 pt | `wip` |
| 35 | PRIMARY | `region_kata_jumla` | 0/4 | 0.9068 | 11.41% | 0.57 pt | 0.3 pt | `wip` |
| 36 | PRIMARY | `region_shule_bora_jumla` | 0/5 | 0.9612 | 4.59% | 0.511 pt | 0.54 pt | `wip` |
| 37 | PRIMARY | `region_shule_bora_masomo_serikali` | 0/3 | 0.9613 | 4.78% | 0.57 pt | 0.48 pt | `wip` |
| 38 | PRIMARY | `region_shule_bora_masomo_jumla` | 0/3 | 0.9596 | 4.50% | 0.39 pt | 0.48 pt | `wip` |
| 39 | PRIMARY | `region_ufaulu_masomo` | 0/3 | 0.9771 | 2.45% | 0.57 pt | 0.24 pt | `wip` |
| 40 | PRIMARY | `region_ufaulu_masomo_jumla` | 0/1 | 0.9771 | 2.05% | 0.45 pt | 0.12 pt | `wip` |
| 41 | PRIMARY | `region_wanafunzi_bora` | 0/6 | 0.9771 | 2.63% | 0.6 pt | 0.42 pt | `wip` |
| 42 | PRIMARY | `region_shule_serikali` | 0/15 | 0.9222 | 8.94% | 0.57 pt | 0.3 pt | `wip` |
| 43 | PRIMARY | `region_shule_binafsi` | 0/4 | 0.9294 | 8.81% | 1.02 pt | 0.3 pt | `wip` |
